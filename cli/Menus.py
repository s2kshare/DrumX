...
def MainMenu():
    menu_items = ["PLAYING: ON" if AppState.get_instance().get_power() else "PLAYING: OFF",
                  "EDIT KIT", "EDIT PADS", "FILE MANAGER"]
    os.system("cls" if os.name == "nt" else "clear")
    print("->->->->->->->->->->->->->->->->->->->->->->->->->->->->->->\n")
    print("                        DrumX")
    print("                    [ MAIN MENU ]\n")
    selected = AppState.get_instance().get_menu_hover()
...
def KitMenu():
    ...
    print("                        DrumX")
    print("                    [ MAIN MENU ]\n")
    current_menu = AppState.get_instance().get_menu() or "kit"
    AppState.set_menu(current_menu)
    menu_items = MENUS[current_menu]
    for i, key in enumerate(menu_items):
        prefix = "* " if i == AppState.get_instance().get_menu_hover() else "  "
        print(f"{prefix}[ {key} ]")
